...
class KsDashboardNinjalive(models.Model):
    ...
    def ks_prepare_export_data_vals(self, ks_dashboard_rec):
        super_rec_data = super(KsDashboardNinjalive, self).ks_prepare_export_data_vals(ks_dashboard_rec)
    ...
    def ks_prepare_import_data_vals(self, data, menu_id):
        ...
        if 'ks_auto_update_type' in data.keys():
            super_rec_data['ks_auto_update_type'] = data['ks_auto_update_type']
            super_rec_data['ks_show_live_pop_up'] = data['ks_show_live_pop_up']
        else:
            super_rec_data['ks_auto_update_type'] = 'ks_live_update'
            super_rec_data['ks_auto_update_type'] = False
        return super_rec_data