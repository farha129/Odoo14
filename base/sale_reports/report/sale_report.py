...
class ReportByCustomer(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if st_date and end_date and partner_id and state:
            docs = self.env['sale.order.line'].search([('order_id.date_order','>=', st_date),('order_id.date_order','<=',end_date),  ('order_partner_id.name','in',partner_id),('invoice_lines.invoice_id.state','=',state)])
