...
class MrpProduction(models.Model):
    ...
    def task_count(self):
        ...
        self.task_number = task_obj.search_count([('project_id', '=',self.project_id.id)])
    ...
    def create_task_mrp(self):
        ...
        for so in sale_obj:
            ...
            # print('bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbdate_mrp_date_1',mrp_date_1)


            # date_mrp = (mrp_date_1).strftime('%Y-%m-%d')
            # print('bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbdate_mrp',date_mrp)
